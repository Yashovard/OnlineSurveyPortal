...
<body>
	...
	<h2 align="center">View Enable Survey List</h2>
	<table border="3" align="center">
		...
		<%
			...
			list = surveyDaoImpl.getEnableSurvey();
		...
		<tr>
			...
			<td><a href="DisableSurvey?surveyno=<%=survey.getSurvey_no()%>">Click here to disable</a></td>
		</tr>
		<%
			}
		%>
